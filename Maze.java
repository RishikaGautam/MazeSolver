...
public final class Maze
{
    ...
    /**
     * Returns whether this maze and another maze have the same wall structure.
     *
     * @param other the maze to which this maze should be compared
     * @return whether this maze and the given maze have the same wall structure
     */
    public boolean equalsWalls(Maze other)
    {
        return Arrays.deepEquals(left, other.left) && Arrays.deepEquals(right, other.right)
                && Arrays.deepEquals(up, other.up) && Arrays.deepEquals(down, other.down);
    }
